...
Detailed Phase 2 results are in reports/Phase_2_Results.md.
...
More detail is available in reports/Phase_1_Observations.md.
...
Hugging Face Datasets, pandas, PyArrow, Parquet
...
CUDA, BF16, gradient checkpointing, bitsandbytes
